                    ...
                    <div class="col-md-12">
						<?php
							...
							if (isset($_POST['ajout']))
							{
								...
								$sql="INSERT INTO `evenements` VALUES ('', '$final_date', '$description','$ajouteur')";
								echo"l'évènement à bien été ajouté </br>";
								$bdd->exec($sql);
								$bdd=null;
							}
						?>
                        <!-- Formulaire d'ajout d'une actualité -->
						<form class="form-horizontal" role="form" action="index1.php?page=ajoutevent.php" method="post">
							<div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="col-md-4">Description de l'évènement : </label>
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="col-md-12">
									  <button type="submit" name="ajout" class="btn btn-default" onsubmit>ajouter l'évènement</button>
									</div>
								</div>
							</div>
						</form>
