...
?>
        <header>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center">Ajout d'une actualité</h1>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
						...
						<form class="form-horizontal" role="form" action="index1.php?page=ajoutactu.php" method="post">
							<div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="form-group">
									<label class="col-md-4">Description de l'actualité : </label>
							...
							<div class="col-md-12">
								<div class="form-group">
									<div class="col-md-12">
									  <button type="submit" name="ajout" class="btn btn-default" onsubmit>ajouter l'actualitée</button>
									</div>
								</div>
							</div>
						</form>
